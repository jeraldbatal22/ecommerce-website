export const ecommerce = 'ecommerce_website'

export const AUTH_KEY = ecommerce + 'auth' // slack_app_auth title for login user data
export const USER = ecommerce + 'user' // slack_app_auth title for login user data
export const CART = ecommerce + '_cart' // slack_app_auth title for login user data
